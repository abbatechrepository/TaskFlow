...
//   return (
//     <div className="flex min-h-screen items-center justify-center bg-gradient-to-br p-4 relative overflow-hidden">{/* from-indigo-600 via-blue-700 to-indigo-900 */}
//       {/* BACKGROUND FX */}
