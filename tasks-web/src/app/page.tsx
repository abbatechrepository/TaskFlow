      ...
      >
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div style={{ display: 'flex', gap: 12, paddingTop: 20, borderTop: '1px solid rgba(255,255,255,0.06)', marginTop: 8 }}>
            <button type="submit" className="btn-green" style={{ flex: 1, fontWeight: 700, fontSize: 14 }}>Salvar Alterações</button>
            {editingTask && (
              <button type="button" className="btn-red" onClick={handleDelete} style={{ fontWeight: 700, fontSize: 14 }}>Excluir</button>
            )}
